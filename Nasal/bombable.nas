var bombableObject = {
  ...
  velocities : {
    ...
    climbTerminalVelocities: {
      point1: { airspeed_kt : 300, vertical_speed_fps : 2500},
      point2: { airspeed_kt : 120, vertical_speed_fps : 0},
    },
  ...
  weapons: {
    ...
    hs_II_1 : {
      #internal name - this can be any name you want; must be a valid nasal variable name
      name: "Hispano Mk. II 20mm cannon",
      # name presented to users, ie in on-screen messages

      maxDamage_percent : 35,
      # maximum percentage damage one hit from the aircraft's main weapon/machine
      # guns will do to an opponent
...
# Duplicate the 0.303 machine guns:
bombableObject.weapons.bmg_303_2 = bombableObject.weapons.bmg_303_1;
bombableObject.weapons.bmg_303_3 = bombableObject.weapons.bmg_303_1;
bombableObject.weapons.bmg_303_4 = bombableObject.weapons.bmg_303_1;
# And also duplicate the mighty Hispano Mk. II cannon:
bombableObject.weapons.hs_II_2 = bombableObject.weapons.hs_II_1;
bombableObject.weapons.hs_II_3 = bombableObject.weapons.hs_II_1;
bombableObject.weapons.hs_II_4 = bombableObject.weapons.hs_II_1;
...
var unload = func (thisNode) {
  print("mosquito: unloading bombable support.");
...
# load() and unload() are executed only when the mosquito is an AI or MP
# aircraft.  When the mosquito is the main aircraft and bombable is
...
setlistener ("/bombable/menusettings/bombable-enabled", func (enabled) {
  ...
  bombable.debprint ("mosquito: Loading main aircraft vulnerabilities and weapons");
